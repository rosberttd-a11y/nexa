...
const FORM_URL = "https://PLACEHOLDER-notion-form.com"; // TODO: Replace with actual Notion form link
...
const FAQ = () => {
  ...
  const faqs = [
    ...
    { q: "¿Dónde están ubicados?", a: "Puedes encontrarnos en nuestra ubicación. Haz clic aquí para ver la dirección exacta en el mapa." },
  ];
  ...
  <footer style={{
    ...
    <div style={{
      ...
      <p style={{ fontSize: 13, color: "var(--gray-400)" }}>
        © 2025 Nexa — Entrenamiento, prevención y recuperación.
      </p>
    </div>
  </footer>
);
